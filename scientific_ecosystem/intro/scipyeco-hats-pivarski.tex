...
\vspace{0.2 cm}
\uncover<3->{Unlike Numpy and Pandas, SciPy isn't something you want fluency in--- it's a bag of functions you dig into on occasion.}
...
\vspace{0.25 cm}
\uncover<6->{Notebook-style interaction is {\it incredibly useful for data analysis} because you must be able to quickly iterate through mistakes, but then also finalize a procedure.}
